/**
 * Weixin iLink protocol types (mirrors proto: GetUpdatesReq/Resp, WeixinMessage,
 * SendMessageReq). API uses JSON over HTTP; bytes fields are base64 strings in JSON.
 *
 * Ported from Tencent/openclaw-weixin (MIT) — see LICENSE.attribution.
 */
...
export interface BaseInfo {
   ...
   * `User-Agent`. Format: UA-style `Name/Version` tokens. For observability
   * only; not used for authentication or routing.
   */
  bot_agent?: string;
}
